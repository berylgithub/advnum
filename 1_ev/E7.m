...
#E7.(iii)
C = [-10 2 -1; 2 -11 2; -1 2 -12]; #corresponds to lambda^2
B = [1 2 1; 2 1 2; 1 2 0]; #to lambda
A = [10 2 -1; 2 9 3; -1 3 10]; #as constant
sigma = -1; #arbitrary constant
[V,D] = lin_quadratic_ev(A, B, C, sigma);
disp("eigenvalues:");
disp(num2str(diag(D), 3));
disp("eigenvectors:");
disp(num2str(V, 3))
